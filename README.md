...
## My Fork for a Custom Creality Ender 3 v2  ** WORK IN PROGRESS **
- Stock Creality Silent 1.4 Board ATmega1280
- TMC2208 Drivers
- E3D Titan Extruder Bowden Configuration
- Inductive Probe (TH3D EZ-ABL mini)
- Stock Fialment Runout Sensor
## Future Upgrades
- MGN12 Linear Motion on X & Y
- Dual Lead Screw
- Direct Drive Conversion

## Features Enabled
- Stealthchop (Spreadcycle) to keep things quiet
